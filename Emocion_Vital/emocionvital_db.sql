...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-07-2025 a las 06:17:41
...
CREATE TABLE `cita` (
  ...
  `servicio` enum('psicoterapia_infantil','psicoterapia_adolescentes','psicoterapia_individual','psicoterapia_parejas') NOT NULL,
  `fecha_cita` date NOT NULL,
  `hora_cita` time NOT NULL,
  `metodo_pago` enum('pago_movil','transferencias','efectivo') NOT NULL,
...
INSERT INTO `cita` (`id_cita`, `id_paciente`, `id_psicologa`, `id_horario`, `modalidad`, `servicio`, `fecha_cita`, `hora_cita`, `metodo_pago`, `Status`) VALUES
(16, 1, 1, 11, '', '', '2025-07-03', '09:30:00', '', 'Confirmada');
...
(2, 1, '', '2025-07-03', 'problema para dormir', 'insomnio', '', '2 semanas', 'no lo se', ': ', 'tranquilo', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(3, 1, '', '2025-07-03', 'problema para dormir', 'insomnio', '', '2 semanas', 'no lo se', ': ', 'tranquilo', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
CREATE TABLE `horario` (
  `id_horario` int(10) UNSIGNED NOT NULL,
  `id_psicologa` int(10) UNSIGNED NOT NULL,
  `dias_laborables` varchar(1000) NOT NULL,
  `horario_laboral` varchar(255) NOT NULL,
...
(11, 1, 'Lunes,Martes,Miercoles,Jueves,Viernes', '09:00,09:30,10:00,10:30,11:00,11:30,13:00,13:30,14:00,14:30,15:00,15:30', 'Activo'),
(12, 1, 'Sabado', '09:00,09:30,10:00,10:30,11:00,11:30,12:00,12:30', 'Activo'),
(13, 1, 'Lunes,Martes,Miercoles,Jueves,Viernes', '18:00,18:30,19:00,19:30,20:00', 'Activo'),
(14, 1, 'Sabado', '16:00,16:30,17:00,17:30,18:00,18:30,19:00', 'Activo');
...
(1, 1, 'Juan', 'Carlos', 'Pérez', 'Ramírez', 'V-12345678', '1995-06-20', 'caracas', 'bachiller', 'trabajador', 'Soltero(a)', 'catolico', '', '', '0', '', 'jefe', '2005', 'Masculino', '04121234567', 'juanperez@gmail.com', '', 1, 4, 2, 'activo');
...
(1, 2, 'Maria', 'Fernanda', 'Mogollon', 'Perez', '04126930012', '', '', 'activo');
...
(1, 'juan.perez@example.com', 'juanp', 'Juan', 'Pérez', 'pbkdf2:sha256:260000$ckHDAqdZXFfU2a1K$232ea3ac5ff4938db3c5c3253cb8f374415bef4bc5eb9c93e50e8d022df23cc0', 'Color favorito', 'Azul', 'Animal Favorito', 'Perro', 'paciente', 'activo'),
(2, 'mariamogollon@gmail.com', 'mmogollon', 'Maria', 'Mogollon', 'pbkdf2:sha256:260000$mnlX7YYPPKuozKyM$f92a91996e9d13affc0906da7564e1922c330a581d2b97d5141fced4fe272174', 'Color Favorito', 'rojo', 'Animal Favorito', 'gato', 'psicologa', 'activo');
...
--
ALTER TABLE `cita`
  MODIFY `id_cita` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `historia_clinica_psicologia`
  MODIFY `id_historia_clinica` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `paciente`
  ...
  ADD CONSTRAINT `paciente_ibfk_2` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_ibfk_3` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_ibfk_4` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE;
