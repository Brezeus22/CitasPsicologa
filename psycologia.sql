...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2025 a las 17:06:21
...
--
-- Base de datos: `psycologia`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `categoria_cita`
--

CREATE TABLE `categoria_cita` (
  `categoria_cita` int(11) NOT NULL,
...
CREATE TABLE `cita` (
  ...
  `codigo_psicologa` int(11) NOT NULL,
  ...
  `link_cita` varchar(255) NOT NULL,
  `estado` enum('Activo','Inactivo','Pendiente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `direccion` (
  ...
  `estado_direccion` int(11) NOT NULL,
  `municipio_direccion` int(11) NOT NULL,
  `parroquia_direccion` int(11) NOT NULL,
...
CREATE TABLE `historial_medico` (
  ...
  `codigo_paciente` int(11) NOT NULL,
  `informacion_del_paciente` varchar(255) NOT NULL,
...
CREATE TABLE `horario` (
  ...
  `dias_no_disponibles` date NOT NULL,
  `horas_disponibles` datetime NOT NULL,
  `horas_no_disponibles` datetime NOT NULL,
  `estado` enum('Activo','Inactivo','Pendiente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `informe_medico` (
  ...
  `tratamiento_paciente` varchar(255) NOT NULL,
  `estado` enum('Activo','Inactivo','Pendiente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `psicologa` (
  `id_psicologa` int(11) NOT NULL,
  `id_usuarios` int(11) NOT NULL,
  `primer_nombre_psicologa` varchar(255) NOT NULL,
  `segundo_nombre_psicologa` varchar(255) NOT NULL,
  `primer_apellido_psicologa` varchar(255) NOT NULL,
  `segundo_apellido_psicologa` varchar(255) NOT NULL,
  `email_psicologa` varchar(255) NOT NULL,
  `cedula_psicologa` varchar(10) NOT NULL,
  `celular_psicologa` varchar(11) NOT NULL,
  `fecha_nacimiento` date NOT NULL,
...
--
-- Estructura de tabla para la tabla `reprogramar_cita`
--

CREATE TABLE `reprogramar_cita` (
  `id_reprogramcion` int(11) NOT NULL,
  `id_cita` int(11) NOT NULL,
  `id_horario` int(11) NOT NULL,
...
CREATE TABLE `sexo_paciente` (
  ...
  `tipo_descripcion_sexo` varchar(250) NOT NULL,
  `estado` enum('Activo','Inactivo','Pendiente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tipo_usuarios` (
  ...
  `tipo_usuarios_descripcion` varchar(250) NOT NULL,
  `estado` enum('Activo','Inactivo','Pendiente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `categoria_cita`
--
ALTER TABLE `categoria_cita`
  ADD PRIMARY KEY (`categoria_cita`);
...
ALTER TABLE `pacientes`
  ...
  ADD UNIQUE KEY `email_paciente` (`email_paciente`);
...
ALTER TABLE `psicologa`
  ...
  ADD UNIQUE KEY `email_psicologa` (`email_psicologa`),
  ADD UNIQUE KEY `cedula_psicologa` (`cedula_psicologa`);

--
-- Indices de la tabla `reprogramar_cita`
--
ALTER TABLE `reprogramar_cita`
  ADD PRIMARY KEY (`id_reprogramcion`);

--
-- Indices de la tabla `sexo_paciente`
--
ALTER TABLE `sexo_paciente`
  ADD PRIMARY KEY (`id_tipo_sexo`);

--
-- Indices de la tabla `tipo_cita`
--
ALTER TABLE `tipo_cita`
  ADD PRIMARY KEY (`tipo_cita`);
...
--
-- AUTO_INCREMENT de la tabla `categoria_cita`
--
ALTER TABLE `categoria_cita`
  MODIFY `categoria_cita` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `metodo_pago`
  MODIFY `metodo_pago` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `reprogramar_cita`
--
ALTER TABLE `reprogramar_cita`
  MODIFY `id_reprogramcion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `sexo_paciente`
--
ALTER TABLE `sexo_paciente`
  MODIFY `id_tipo_sexo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tipo_cita`
--
ALTER TABLE `tipo_cita`
  MODIFY `tipo_cita` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tipo_usuarios`
--
ALTER TABLE `tipo_usuarios`
  MODIFY `id_tipo_usuarios` int(11) NOT NULL AUTO_INCREMENT;
